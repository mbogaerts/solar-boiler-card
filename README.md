# Solar Boiler Card by [@mbogaerts](https://www.github.com/mbogaerts)

A universal Solar Boiler card
...
| ----------------- | ------- | ------------ | ------------------------------------------- | ------------------- |
| type              | string  | **Required** | `custom:solar-boiler-card`                   |
...
## Starting a new card from solar-boiler-card
...
## Starting a new card from solar-boiler-card with [devcontainer][devcontainer]
...
3. The compiled `.js` file will be accessible on
   `http://127.0.0.1:5000/solar-boiler-card.js`.
4. On a running Home Assistant installation add this to your Lovelace
   `resources:`

```yaml
- url: 'http://127.0.0.1:5000/solar-boiler-card.js'
  type: module
```
